...
from app.api import api_user, api_login, api_register, api_healthcheck, api_player
...
router.include_router(api_player.router, tags=["player"], prefix="/api/player/games")
